 ...
 * `Webpractik\Agent\AgentTask` in the same format: `\Vendor\Package\ClassName::agent()->%method%();`.
...
trait AgentTrait
{
     ...
     * `Webpractik\Agent\AgentTask`. All arguments from this method should
    ...
    {
        return AgentHelper::createName(static::class, static::$constructorArgs, $callChain);
    }
